...
four mart aggregates. Singular tests (`assert_snapshot_current_uniqueness`,
`assert_monthly_row_counts_sane`) hang off the layers they protect.
Reproduce locally with `make docs`.
